namespace LeonSutedja.BookingSystem.Shared.TableCreator
{
    ...
    public interface ITableColumn<T> : ITableColumn where T : Entity
    {
    ...
    public abstract class TableColumn<T> : ITableColumn<T> where T : Entity
    {
        ...
        public virtual bool IsSortDisable
        {
            get
            {
                return false;
        ...
        public virtual bool IsFilterDisable
        {
            get
            {
                return false;
        ...
        public virtual IEnumerable<string> StringFilterValues
        {
            get { return Enumerable.Empty<string>(); }
        }

        public virtual int? HeadlineSequenceNumber
        {
            get { return null; }
        }
    ...
    public abstract class StringTableColumn<T> : TableColumn<T> where T : Entity
    {
        ...
        public override TableColumnFilterStrategy FilterStrategy
        {
            get
            {
                return TableColumnFilterStrategy.FreeText;
            }
        }
    ...
    public abstract class DateTimeTableColumn<T> : TableColumn<T> where T : Entity
    {
        ...
        public override TableColumnFilterStrategy FilterStrategy
        {
            get
            {
                return TableColumnFilterStrategy.DateRange;
            }
        }
        ...
        where TEnum : struct
    {
        ...
        public override IEnumerable<string> StringFilterValues
        {
            get
            {
                return _stringValidValues;
            }
        }
        ...
        public override TableColumnFilterStrategy FilterStrategy
        {
            get
            {
                return TableColumnFilterStrategy.MultiSelection;
            }
        }
    ...
    public abstract class StringMultiselectTableColumn<T> : TableColumn<T>
        where T : Entity
    {
        private readonly List<string> _stringValidValues;
    ...
    public abstract class FlagTableColumn<T> : TableColumn<T> where T : Entity
    {
        ...
        public override TableColumnFilterStrategy FilterStrategy
        {
            get
            {
                return TableColumnFilterStrategy.Flag;
            }
        }
